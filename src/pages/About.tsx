...
const blocks = [
  {
    ...
    text: "Мы сделали полотно темнее и глубже: графитовые слои, стекло и насыщенные акцентные блики.",
  },
  {
    icon: Sparkles,
    ...
    <div className="space-y-6">
      <section className="glass rounded-[2rem] p-6 sm:p-8">
        ...
        <p className="mt-4 max-w-3xl text-muted-foreground">
          Редизайн сфокусирован на тёмной премиальной атмосфере, стеклянных слоях и более
          агрессивной анимационной подаче. Интерфейс стал визуально дороже и живее, сохранил простую
